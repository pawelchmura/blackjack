...
function RandomCard() {
  ...
  delete deck[card];
  const cardWithoutSuffix = card.split("-")[0];
  console.log(a);

  return cardWithoutSuffix;
}
...
function stand() {
  ...
  function compare() {
    ...
    document.getElementById(
      "total-chips"
    ).innerHTML = `Total Chips Value: ${totalChips}$`;
  }
...
function initGame() {
  ...
  document.getElementById(
    "player-cards"
  ).innerHTML = `<img src="images/${firstPCard}.jpeg" class="card">
         <img src="images/${secondPCard}.jpeg" class="card">`;

  document.getElementById(
    "dealer-cards"
  ).innerHTML = `<img src="images/${firstDCard}.jpeg" class="card">
...
function Hit() {
  ...
  document.getElementById(
    "player-cards"
  ).innerHTML += `<img src="images/${newPCard}.jpeg" class="card">`;
...
function dealerMove() {
  ...
  while (dPoints < 17) {
    ...
    document.getElementById(
      "dealer-cards"
    ).innerHTML += `<img src="images/${newDCard}.jpeg" class="card">`;
...
function resetRound() {
  ...
  document.getElementById("dealer-cards").innerHTML =
    '<img src="images/back.jpeg" class="card"><img src="images/back.jpeg" class="card">';
  //deck = createDeck();
  // shuffling jest w funkcji shuffle()
  addedcards = 0;
  info("");
}
...
function double() {
  ...
  document.getElementById("bet-value").value = bet;
  Hit();
  stand();
}
